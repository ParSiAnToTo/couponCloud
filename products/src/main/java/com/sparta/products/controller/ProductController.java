package com.sparta.products.controller;
...
import com.sparta.products.service.ProductService;
...
public class ProductController {
    ...
    public ResponseEntity<?> getProductBySimpleId(@PathVariable("productId") Long productId) {
        ProductDto product = productService.getProductDtoById(productId);
        return ResponseEntity.ok(product);
    }

    @PostMapping("/multicall")
